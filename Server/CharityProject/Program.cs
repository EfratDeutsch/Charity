...
string estysconnectionString = "Data Source=DESKTOP-MVIL733\\MSSQLSERVER2;Initial Catalog=Charity;Integrated Security=True;TrustServerCertificate=True;";
...
builder.Services.AddDbContext<CharityContext>(options =>options.UseSqlServer(EfratHomeConnectionString));

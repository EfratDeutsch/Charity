...
namespace CharityProject.Controllers
{
    ...
    public class LoanController : ControllerBase
    {
        ...
        // GET api/<LoanController>/filterDetails
        [HttpGet("GetFilter")]
        public async Task<ActionResult<Loan>> GetFilter(int charityId, [FromQuery] string? name = null, [FromQuery] string? email = null, [FromQuery] string? borrowName = null)
        {
            IEnumerable<Loan> product = await _loanService.getLoansByFilter(charityId,name,email,borrowName);
            return Ok(product);
        }
        [HttpPost]
